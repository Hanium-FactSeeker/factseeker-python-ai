...
- 팩트체크 가능한 경우에는, **정확하고 간결한 (주어+목적어+서술어)문장 형태로 정제하여 출력**해야 합니다.
...
!!!제일 중요!!! 자막에 등장하지 않은 정보나 생성된 문장은 절대 포함하지 마세요. 자막에 명시된 범위 내에서만 판단해야 합니다.
※ 다만, '지시했다', '요청했다', '비판했다' 등 **행위성 발언**은 반드시 **그 대상(무엇을 지시했는지, 비판했는지 등)을 포함**하도록 문장을 보완해 주세요.  
