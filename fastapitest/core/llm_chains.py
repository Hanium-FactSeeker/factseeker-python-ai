...
2.  **주장 사실 여부 판단:**
    * **참**: 뉴스 문장이 **주장의 내용이 사실임을 명확하게 뒷받침**하는 경우.
    * **거짓**: 뉴스 문장이 **주장의 내용이 사실이 아님을 명확하게 반박**하는 경우. (예: 주장은 '사퇴했다'인데 문맥은 '사퇴설을 부인했다')
    * **알수없음**: 뉴스 문장이 주장과 관련된 주제는 다루지만, 주장이 사실인지 거짓인지 직접적으로 판단할 근거가 없는 경우. (예: 관련 논란이 있다는 사실만 전달)
    * **[핵심 규칙] 주장이 특정 사건에 대한 '해석'이나 '성격 규정'(예: '표적 수사', '정치적 탄압')을 포함한다면, 뉴스 스니펫은 그 '해석' 자체가 사실임을 직접적으로 명시해야만 "참"으로 판단할 수 있습니다.** 단순히 사건의 객관적인 진행 상황만 다룬다면 "알수없음"입니다.

[출력 형식]
- 관련성: 예 / 아니오
- 주장 사실 여부: 참 / 거짓 / 알수없음  <- 이 부분을 통해 최종 판정을 내립니다.
